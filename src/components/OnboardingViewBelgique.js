...
const JOURNEES_BELGIQUE = (onLaunchModule, onLaunchPeerQuiz) => [
  {
    ...
    modules: [
      ...
      },
      {
        ...
        onClick: () => onLaunchModule('types-verres', 'journee1'),
      },
      {
        visual: 'emoji', icon: '👓',
        label: 'Connaissances Montures',
        sub: 'Acétate · Métal · Injecté — fin de journée',
        onClick: () => onLaunchModule('montures', 'journee1'),
      },
      {
        visual: 'emoji', icon: '🔍',
  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        onClick: () => onLaunchModule('trame-accueil', 'journee2'),
      },
      {
        visual: 'emoji', icon: '🏷️',
        label: 'Les offres',
    ...
    modules: [
      {
        ...
        onClick: () => onLaunchModule('pdm', 'journee3'),
      },
      {
        visual: 'emoji', icon: '🛡️',
        label: 'Mutuelles et INAMI',
        sub: 'Remboursements · INAMI · Mutuelles belges',
        onClick: () => onLaunchModule('mutuelles-inami', 'journee3'),
      },
    ],
  },
  {
