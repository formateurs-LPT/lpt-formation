...
const PAGE_TYPE_LABELS = {
  'parcours-rembourses-offres': { icon: '🏷️', label: 'Les offres' },
  'parcours-tiers-payant':      { icon: '🙋', label: 'Question ouverte' },
  'tiers-payant-explication':   { icon: '💡', label: 'Explication' },
}
          ...
          <div>
            ...
            <div style={{ marginTop: 12, padding: '14px 18px', background: 'rgba(77,184,92,0.08)', border: '1px solid rgba(77,184,92,0.25)', borderRadius: 12 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <img src="/assets/logo-lpt-sante.png" alt="LPT Santé" width={36} height={36} style={{ objectFit: 'contain', flexShrink: 0 }} />
                <div>
