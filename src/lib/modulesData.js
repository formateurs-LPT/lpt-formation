...
export const QUIZ_FINAL_QUESTIONS = [
  ...
  // Lecture d'ordonnance
  {
    ...
    options: ["L'œil gauche", "L'œil droit", "Les deux yeux"],
    correct: 1,
  },
  {
  ...
  {
    question: "À partir de quel âge le délai de renouvellement de lunettes passe à 2 ans ?",
  ...
  },
  {
    ...
    options: ["Variable selon la mutuelle", "50€", "0€"],
    correct: 2,
  },
  {
